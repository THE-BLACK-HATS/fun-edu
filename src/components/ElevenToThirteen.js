...
const question = [
    ...
    'How much time you spend on social space'
]
const option1 = [
    ...
    'As much as possible',
    'Somewhat active, in a positive environment'
]
const option2 = [
            ...
            <div className="card-body">
                ...
                <div className="container-fluid d-flex flex-sm-column flex-md-column flex-lg-row flex-wrap align-items-center justify-content-center">
                    ...
                    <div className="card m-2 mb-3" style={{ maxWidth: "420px" }}>
                        <div className="d-flex flex-wrap flex-sm-column flex-md-row flex-lg-row">
                            <div className="col-md-4" style={{ overflow: 'hidden' }}>
                                <img src={music11_13} className="img-fluid rounded-start" alt="logo"
                                    style={{
                                        transform: "scale(2.4)"
                                    }} />
                            </div>
                            <div className="col-md-8">
                                <div className="card-body">
                                    ...
                                    <Link className="card-text text-danger d-block text-end" to="/elevenToThirteen/music">
                                        <small>Listen !</small>
                                    </Link>
                                </div>
                            </div>
                    ...
                    <div className="card m-2 mb-3" style={{ maxWidth: "420px" }}>
                        <div className="d-flex flex-wrap flex-sm-column flex-md-row flex-lg-row">
                            <div className="col-md-4" style={{ overflow: 'hidden' }}>
                                <img src={video11_13} className="img-fluid rounded-start" alt="logo"
                                    style={{
                                        transform: "scale(2.4)"
                                    }} />
                            </div>
                    ...
                    <div className="card m-2 mb-3" style={{ maxWidth: "420px" }}>
                        <div className="d-flex flex-wrap flex-sm-column flex-md-row flex-lg-row">
                            <div className="col-md-4" style={{ overflow: 'hidden' }}>
                                <img src={books11_13} className="img-fluid rounded-start" alt="logo"
                                    style={{
                                        transform: "scale(2.4)"
                                    }} />
                            </div>
...
export default ElevenToThirteen
