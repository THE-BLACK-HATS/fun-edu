...
// 14-18 years
import music14_18 from '../assets/logo/14 - 18 YRS MUSIC.jpg'
import video14_18 from '../assets/logo/14-18 YRS VIDEO.jpg'
import books14_18 from '../assets/logo/14-18 YRS E-BOOKS.jpg'
import moral14_18 from '../assets/logo/moral.jpg'
import career14_18 from '../assets/logo/career path.jpg'
...
const question = [
    'Select your study hours apart from your play/relaxment hours:',
    ...
    'Did you ever felt low ? If yes, how many times? (Answer honestly)'
]
const option1 = [
    'More than 6 hours per day',
    'Yes, I know',
    'Autobiographies / Personality Developement',
    'Atleast an hour',
    'No, I am absolutely fine and motivated'
]
const option2 = [
    ...
    'Connective Books',
    'Depends on mood',
    'Frequently, help me out, I want to get rid of all these'
]
const option3 = [
    'Depends on mood, nothing fixed',
            ...
            <div className="card-body">
                ...
                <div className="container-fluid d-flex flex-sm-column flex-md-column flex-lg-row flex-wrap align-items-center justify-content-center">
                    ...
                    <div className="card m-2 mb-3" style={{ maxWidth: "420px" }}>
                        <div className="d-flex flex-wrap flex-sm-column flex-md-row flex-lg-row">
                            <div className="col-md-4" style={{ overflow: 'hidden' }}>
                                <img src={music14_18} className="img-fluid rounded-start" alt="logo"
                                    style={{
                                        transform: "scale(2.4)"
                                    }} />
                            </div>
                    ...
                    <div className="card m-2 mb-3" style={{ maxWidth: "420px" }}>
                        <div className="d-flex flex-wrap flex-sm-column flex-md-row flex-lg-row">
                            <div className="col-md-4" style={{ overflow: 'hidden' }}>
                                <img src={video14_18} className="img-fluid rounded-start" alt="logo"
                                    style={{
                                        transform: "scale(2.4)"
                                    }} />
                            </div>
                    ...
                    <div className="card m-2 mb-3" style={{ maxWidth: "420px" }}>
                        <div className="d-flex flex-wrap flex-sm-column flex-md-row flex-lg-row">
                            <div className="col-md-4" style={{ overflow: 'hidden' }}>
                                <img src={books14_18} className="img-fluid rounded-start" alt="logo"
                                    style={{
                                        transform: "scale(2.4)"
                                    }} />
                            </div>
                    ...
                    <div className="card m-2 mb-3" style={{ maxWidth: "420px" }}>
                        <div className="d-flex flex-wrap flex-sm-column flex-md-row flex-lg-row">
                            <div className="col-md-4" style={{ overflow: 'hidden' }}>
                                <img src={moral14_18} className="img-fluid rounded-start" alt="logo"
                                    style={{
                                        transform: "scale(2.4)"
                                    }} />
                            </div>
                    ...
                    <div className="card m-2 mb-3" style={{ maxWidth: "420px" }}>
                        <div className="d-flex flex-wrap flex-sm-column flex-md-row flex-lg-row">
                            <div className="col-md-4" style={{ overflow: 'hidden' }}>
                                <img src={career14_18} className="img-fluid rounded-start" alt="logo"
                                    style={{
                                        transform: "scale(2.4)"
                                    }} />
                            </div>
...
export default FourteenToEighteen
